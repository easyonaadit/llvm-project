...
; GFX8DAGISEL-NEXT:    s_mul_i32 s0, s3, s4
; GFX8DAGISEL-NEXT:    s_mul_hi_u32 s3, s2, s4
; GFX8DAGISEL-NEXT:    s_add_u32 s3, s3, s0
; GFX8DAGISEL-NEXT:    s_add_u32 s1, s3, s1
...
; GFX8GISEL-NEXT:    s_mul_i32 s4, s4, -1
; GFX8GISEL-NEXT:    s_ashr_i32 s5, s4, 31
; GFX8GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8GISEL-NEXT:    s_mul_i32 s3, s3, s4
; GFX8GISEL-NEXT:    s_mul_hi_u32 s6, s2, s4
...
; GFX9DAGISEL-NEXT:    s_mul_i32 s4, s4, -1
; GFX9DAGISEL-NEXT:    s_ashr_i32 s5, s4, 31
; GFX9DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9DAGISEL-NEXT:    s_mul_i32 s3, s3, s4
; GFX9DAGISEL-NEXT:    s_mul_hi_u32 s6, s2, s4
; GFX9DAGISEL-NEXT:    s_mul_i32 s5, s2, s5
; GFX9DAGISEL-NEXT:    s_add_u32 s3, s6, s3
; GFX9DAGISEL-NEXT:    s_mul_i32 s2, s2, s4
; GFX9DAGISEL-NEXT:    s_add_u32 s3, s3, s5
...
; GFX9GISEL-NEXT:    s_mul_hi_u32 s6, s2, s4
; GFX9GISEL-NEXT:    s_mul_i32 s5, s2, s5
; GFX9GISEL-NEXT:    s_add_u32 s3, s6, s3
; GFX9GISEL-NEXT:    s_mul_i32 s2, s2, s4
; GFX9GISEL-NEXT:    s_add_u32 s3, s3, s5
; GFX9GISEL-NEXT:    v_mov_b32_e32 v0, s2
...
; GFX8DAGISEL-NEXT:    s_mov_b64 s[2:3], exec
; GFX8DAGISEL-NEXT:    s_bcnt1_i32_b64 s2, s[2:3]
; GFX8DAGISEL-NEXT:    s_mul_i32 s2, s2, -1
; GFX8DAGISEL-NEXT:    s_ashr_i32 s3, s2, 31
; GFX8DAGISEL-NEXT:    s_mul_i32 s4, s2, 0
; GFX8DAGISEL-NEXT:    s_mul_hi_u32 s5, 0x7b, s2
; GFX8DAGISEL-NEXT:    s_mulk_i32 s3, 0x7b
; GFX8DAGISEL-NEXT:    s_add_u32 s4, s5, s4
...
; GFX8GISEL-NEXT:    s_mov_b64 s[2:3], exec
; GFX8GISEL-NEXT:    s_bcnt1_i32_b64 s2, s[2:3]
; GFX8GISEL-NEXT:    s_mul_i32 s2, s2, -1
; GFX8GISEL-NEXT:    s_ashr_i32 s3, s2, 31
; GFX8GISEL-NEXT:    s_mul_i32 s4, s2, 0
; GFX8GISEL-NEXT:    s_mul_hi_u32 s5, 0x7b, s2
; GFX8GISEL-NEXT:    s_mulk_i32 s3, 0x7b
; GFX8GISEL-NEXT:    s_add_u32 s4, s5, s4
...
; GFX9DAGISEL-NEXT:    s_bcnt1_i32_b64 s2, s[2:3]
; GFX9DAGISEL-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX9DAGISEL-NEXT:    s_mul_i32 s2, s2, -1
; GFX9DAGISEL-NEXT:    s_ashr_i32 s3, s2, 31
; GFX9DAGISEL-NEXT:    s_mul_i32 s4, s2, 0
; GFX9DAGISEL-NEXT:    s_mul_hi_u32 s5, 0x7b, s2
; GFX9DAGISEL-NEXT:    s_mulk_i32 s3, 0x7b
; GFX9DAGISEL-NEXT:    s_add_u32 s4, s5, s4
...
; GFX9GISEL-NEXT:    s_bcnt1_i32_b64 s2, s[2:3]
; GFX9GISEL-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX9GISEL-NEXT:    s_mul_i32 s2, s2, -1
; GFX9GISEL-NEXT:    s_ashr_i32 s3, s2, 31
; GFX9GISEL-NEXT:    s_mul_i32 s4, s2, 0
; GFX9GISEL-NEXT:    s_mul_hi_u32 s5, 0x7b, s2
; GFX9GISEL-NEXT:    s_mulk_i32 s3, 0x7b
; GFX9GISEL-NEXT:    s_add_u32 s4, s5, s4
...
; GFX1064DAGISEL-NEXT:    s_mul_hi_u32 s5, 0x7b, s2
; GFX1064DAGISEL-NEXT:    s_mulk_i32 s3, 0x7b
; GFX1064DAGISEL-NEXT:    s_add_u32 s4, s5, s4
...
; GFX1064GISEL-NEXT:    s_mul_hi_u32 s5, 0x7b, s2
; GFX1064GISEL-NEXT:    s_mulk_i32 s3, 0x7b
; GFX1064GISEL-NEXT:    s_add_u32 s4, s5, s4
...
; GFX1032DAGISEL-NEXT:    s_mul_hi_u32 s5, 0x7b, s2
; GFX1032DAGISEL-NEXT:    s_mulk_i32 s3, 0x7b
; GFX1032DAGISEL-NEXT:    s_add_u32 s4, s5, s4
...
; GFX1032GISEL-NEXT:    s_mul_hi_u32 s5, 0x7b, s2
; GFX1032GISEL-NEXT:    s_mulk_i32 s3, 0x7b
; GFX1032GISEL-NEXT:    s_add_u32 s4, s5, s4
...
; GFX1164DAGISEL-NEXT:    s_mul_hi_u32 s5, 0x7b, s2
; GFX1164DAGISEL-NEXT:    s_mulk_i32 s3, 0x7b
; GFX1164DAGISEL-NEXT:    s_add_u32 s4, s5, s4
...
; GFX1164GISEL-NEXT:    s_mul_hi_u32 s5, 0x7b, s2
; GFX1164GISEL-NEXT:    s_mulk_i32 s3, 0x7b
; GFX1164GISEL-NEXT:    s_add_u32 s4, s5, s4
...
; GFX1132DAGISEL-NEXT:    s_mul_hi_u32 s5, 0x7b, s2
; GFX1132DAGISEL-NEXT:    s_mulk_i32 s3, 0x7b
; GFX1132DAGISEL-NEXT:    s_add_u32 s4, s5, s4
...
; GFX1132GISEL-NEXT:    s_mul_hi_u32 s5, 0x7b, s2
; GFX1132GISEL-NEXT:    s_mulk_i32 s3, 0x7b
; GFX1132GISEL-NEXT:    s_add_u32 s4, s5, s4
...
; GFX8DAGISEL-NEXT:    s_ashr_i32 s3, s2, 31
; GFX8DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8DAGISEL-NEXT:    s_mul_i32 s4, s1, s2
; GFX8DAGISEL-NEXT:    s_mul_hi_u32 s5, s0, s2
; GFX8DAGISEL-NEXT:    s_mul_i32 s3, s0, s3
; GFX8DAGISEL-NEXT:    s_add_u32 s4, s5, s4
...
; GFX8GISEL-NEXT:    s_ashr_i32 s3, s2, 31
; GFX8GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8GISEL-NEXT:    s_mul_i32 s4, s1, s2
; GFX8GISEL-NEXT:    s_mul_hi_u32 s5, s0, s2
; GFX8GISEL-NEXT:    s_mul_i32 s3, s0, s3
; GFX8GISEL-NEXT:    s_add_u32 s4, s5, s4
...
; GFX9DAGISEL-NEXT:    s_ashr_i32 s3, s2, 31
; GFX9DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9DAGISEL-NEXT:    s_mul_i32 s4, s1, s2
; GFX9DAGISEL-NEXT:    s_mul_hi_u32 s5, s0, s2
; GFX9DAGISEL-NEXT:    s_mul_i32 s3, s0, s3
; GFX9DAGISEL-NEXT:    s_add_u32 s4, s5, s4
...
; GFX9GISEL-NEXT:    s_ashr_i32 s3, s2, 31
; GFX9GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9GISEL-NEXT:    s_mul_i32 s4, s1, s2
; GFX9GISEL-NEXT:    s_mul_hi_u32 s5, s0, s2
; GFX9GISEL-NEXT:    s_mul_i32 s3, s0, s3
; GFX9GISEL-NEXT:    s_add_u32 s4, s5, s4
...
; GFX1064DAGISEL-NEXT:    s_mul_hi_u32 s5, s0, s2
...
; GFX1064GISEL-NEXT:    s_mul_hi_u32 s5, s0, s2
...
; GFX1032DAGISEL-NEXT:    s_mul_hi_u32 s5, s0, s2
...
; GFX1032GISEL-NEXT:    s_mul_hi_u32 s5, s0, s2
...
; GFX1164DAGISEL-NEXT:    s_mul_hi_u32 s5, s0, s2
...
; GFX1164GISEL-NEXT:    s_mul_hi_u32 s5, s0, s2
...
; GFX1132DAGISEL-NEXT:    s_mul_hi_u32 s5, s0, s2
...
; GFX1132GISEL-NEXT:    s_mul_hi_u32 s5, s0, s2
...
; GFX8DAGISEL-NEXT:    s_mul_i32 s8, s8, -1
; GFX8DAGISEL-NEXT:    s_ashr_i32 s9, s8, 31
; GFX8DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8DAGISEL-NEXT:    s_mul_i32 s3, s3, s8
; GFX8DAGISEL-NEXT:    s_mul_hi_u32 s10, s2, s8
; GFX8DAGISEL-NEXT:    s_mul_i32 s9, s2, s9
; GFX8DAGISEL-NEXT:    s_add_u32 s3, s10, s3
; GFX8DAGISEL-NEXT:    s_mul_i32 s8, s2, s8
; GFX8DAGISEL-NEXT:    s_add_u32 s9, s3, s9
...
; GFX8DAGISEL-NEXT:    s_mul_i32 s6, s6, -1
; GFX8DAGISEL-NEXT:    s_ashr_i32 s7, s6, 31
; GFX8DAGISEL-NEXT:    s_mul_i32 s5, s5, s6
; GFX8DAGISEL-NEXT:    s_mul_hi_u32 s8, s4, s6
; GFX8DAGISEL-NEXT:    s_mul_i32 s7, s4, s7
; GFX8DAGISEL-NEXT:    s_add_u32 s5, s8, s5
; GFX8DAGISEL-NEXT:    s_mul_i32 s4, s4, s6
; GFX8DAGISEL-NEXT:    s_add_u32 s5, s5, s7
...
; GFX8GISEL-NEXT:    s_mul_i32 s6, s6, -1
; GFX8GISEL-NEXT:    s_ashr_i32 s7, s6, 31
; GFX8GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8GISEL-NEXT:    s_mul_i32 s3, s3, s6
; GFX8GISEL-NEXT:    s_mul_hi_u32 s10, s2, s6
; GFX8GISEL-NEXT:    s_mul_i32 s7, s2, s7
; GFX8GISEL-NEXT:    s_add_u32 s3, s10, s3
; GFX8GISEL-NEXT:    s_mul_i32 s6, s2, s6
; GFX8GISEL-NEXT:    s_add_u32 s7, s3, s7
...
; GFX8GISEL-NEXT:    s_mul_hi_u32 s8, s4, s6
; GFX8GISEL-NEXT:    s_mul_i32 s7, s4, s7
; GFX8GISEL-NEXT:    s_add_u32 s5, s8, s5
; GFX8GISEL-NEXT:    s_mul_i32 s6, s4, s6
; GFX8GISEL-NEXT:    s_add_u32 s7, s5, s7
...
; GFX9DAGISEL-NEXT:    v_cmp_lt_u32_e32 vcc, 15, v0
; GFX9DAGISEL-NEXT:    ; implicit-def: $sgpr8_sgpr9
...
; GFX9DAGISEL-NEXT:  ; %bb.1: ; %else
; GFX9DAGISEL-NEXT:    s_mov_b64 s[8:9], exec
; GFX9DAGISEL-NEXT:    s_bcnt1_i32_b64 s8, s[8:9]
; GFX9DAGISEL-NEXT:    s_mul_i32 s8, s8, -1
; GFX9DAGISEL-NEXT:    s_ashr_i32 s9, s8, 31
; GFX9DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9DAGISEL-NEXT:    s_mul_i32 s3, s3, s8
; GFX9DAGISEL-NEXT:    s_mul_hi_u32 s10, s2, s8
; GFX9DAGISEL-NEXT:    s_mul_i32 s9, s2, s9
; GFX9DAGISEL-NEXT:    s_add_u32 s3, s10, s3
; GFX9DAGISEL-NEXT:    s_mul_i32 s8, s2, s8
; GFX9DAGISEL-NEXT:    s_add_u32 s9, s3, s9
; GFX9DAGISEL-NEXT:  .LBB9_2: ; %Flow
; GFX9DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9DAGISEL-NEXT:    s_or_saveexec_b64 s[2:3], s[4:5]
; GFX9DAGISEL-NEXT:    v_mov_b32_e32 v0, s8
; GFX9DAGISEL-NEXT:    v_mov_b32_e32 v1, s9
...
; GFX9DAGISEL-NEXT:    s_mul_i32 s4, s4, -1
; GFX9DAGISEL-NEXT:    s_ashr_i32 s5, s4, 31
; GFX9DAGISEL-NEXT:    s_mul_i32 s7, s7, s4
; GFX9DAGISEL-NEXT:    s_mul_hi_u32 s8, s6, s4
; GFX9DAGISEL-NEXT:    s_mul_i32 s5, s6, s5
; GFX9DAGISEL-NEXT:    s_add_u32 s7, s8, s7
; GFX9DAGISEL-NEXT:    s_mul_i32 s4, s6, s4
; GFX9DAGISEL-NEXT:    s_add_u32 s5, s7, s5
; GFX9DAGISEL-NEXT:    v_mov_b32_e32 v0, s4
...
; GFX9GISEL-NEXT:    s_mul_i32 s6, s6, -1
; GFX9GISEL-NEXT:    s_ashr_i32 s7, s6, 31
; GFX9GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9GISEL-NEXT:    s_mul_i32 s3, s3, s6
; GFX9GISEL-NEXT:    s_mul_hi_u32 s10, s2, s6
; GFX9GISEL-NEXT:    s_mul_i32 s7, s2, s7
; GFX9GISEL-NEXT:    s_add_u32 s3, s10, s3
; GFX9GISEL-NEXT:    s_mul_i32 s6, s2, s6
; GFX9GISEL-NEXT:    s_add_u32 s7, s3, s7
...
; GFX9GISEL-NEXT:    s_mul_hi_u32 s8, s6, s4
; GFX9GISEL-NEXT:    s_mul_i32 s5, s6, s5
; GFX9GISEL-NEXT:    s_add_u32 s7, s8, s7
; GFX9GISEL-NEXT:    s_mul_i32 s6, s6, s4
; GFX9GISEL-NEXT:    s_add_u32 s7, s7, s5
...
; GFX1032GISEL-NEXT:    s_mul_hi_u32 s7, s6, s3
; GFX1032GISEL-NEXT:    s_mul_i32 s4, s6, s4
; GFX1032GISEL-NEXT:    s_add_u32 s5, s7, s5
