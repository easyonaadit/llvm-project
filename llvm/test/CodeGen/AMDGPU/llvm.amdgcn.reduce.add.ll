...
; GFX8GISEL-NEXT:    s_mul_hi_u32 s5, s2, s4
...
; GFX9DAGISEL-NEXT:    s_mul_hi_u32 s5, s2, s4
...
; GFX9GISEL-NEXT:    s_mul_hi_u32 s5, s2, s4
...
; GFX8DAGISEL-NEXT:    s_mov_b64 s[2:3], exec
; GFX8DAGISEL-NEXT:    s_bcnt1_i32_b64 s2, s[2:3]
; GFX8DAGISEL-NEXT:    s_mul_i32 s3, s2, 0
; GFX8DAGISEL-NEXT:    s_mul_hi_u32 s4, 0x7b, s2
; GFX8DAGISEL-NEXT:    s_mulk_i32 s2, 0x7b
...
; GFX8GISEL-NEXT:    s_mov_b64 s[2:3], exec
; GFX8GISEL-NEXT:    s_bcnt1_i32_b64 s2, s[2:3]
; GFX8GISEL-NEXT:    s_mul_i32 s3, s2, 0
; GFX8GISEL-NEXT:    s_mul_hi_u32 s4, 0x7b, s2
; GFX8GISEL-NEXT:    s_mulk_i32 s2, 0x7b
...
; GFX9DAGISEL-NEXT:    s_mov_b64 s[2:3], exec
; GFX9DAGISEL-NEXT:    s_bcnt1_i32_b64 s2, s[2:3]
; GFX9DAGISEL-NEXT:    s_mul_i32 s3, s2, 0
; GFX9DAGISEL-NEXT:    s_mul_hi_u32 s4, 0x7b, s2
; GFX9DAGISEL-NEXT:    s_mulk_i32 s2, 0x7b
...
; GFX9GISEL-NEXT:    s_mov_b64 s[2:3], exec
; GFX9GISEL-NEXT:    s_bcnt1_i32_b64 s2, s[2:3]
; GFX9GISEL-NEXT:    s_mul_i32 s3, s2, 0
; GFX9GISEL-NEXT:    s_mul_hi_u32 s4, 0x7b, s2
; GFX9GISEL-NEXT:    s_mulk_i32 s2, 0x7b
...
; GFX8DAGISEL-NEXT:    s_bcnt1_i32_b64 s2, s[2:3]
; GFX8DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8DAGISEL-NEXT:    s_mul_i32 s3, s1, s2
; GFX8DAGISEL-NEXT:    s_mul_hi_u32 s4, s0, s2
; GFX8DAGISEL-NEXT:    s_mul_i32 s2, s0, s2
; GFX8DAGISEL-NEXT:    s_add_u32 s3, s4, s3
; GFX8DAGISEL-NEXT:    v_mov_b32_e32 v0, s0
; GFX8DAGISEL-NEXT:    v_mov_b32_e32 v2, s2
...
; GFX8GISEL-NEXT:    s_bcnt1_i32_b64 s2, s[2:3]
; GFX8GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8GISEL-NEXT:    s_mul_i32 s3, s1, s2
; GFX8GISEL-NEXT:    s_mul_hi_u32 s4, s0, s2
; GFX8GISEL-NEXT:    s_mul_i32 s2, s0, s2
; GFX8GISEL-NEXT:    s_add_u32 s3, s4, s3
; GFX8GISEL-NEXT:    v_mov_b32_e32 v0, s2
; GFX8GISEL-NEXT:    v_mov_b32_e32 v3, s1
...
; GFX9DAGISEL-NEXT:    v_mov_b32_e32 v2, 0
; GFX9DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9DAGISEL-NEXT:    s_mul_i32 s3, s1, s2
; GFX9DAGISEL-NEXT:    s_mul_hi_u32 s4, s0, s2
; GFX9DAGISEL-NEXT:    s_mul_i32 s2, s0, s2
; GFX9DAGISEL-NEXT:    s_add_u32 s3, s4, s3
; GFX9DAGISEL-NEXT:    v_mov_b32_e32 v0, s2
; GFX9DAGISEL-NEXT:    v_mov_b32_e32 v1, s3
...
; GFX9GISEL-NEXT:    v_mov_b32_e32 v2, 0
; GFX9GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9GISEL-NEXT:    s_mul_i32 s3, s1, s2
; GFX9GISEL-NEXT:    s_mul_hi_u32 s4, s0, s2
; GFX9GISEL-NEXT:    s_mul_i32 s2, s0, s2
; GFX9GISEL-NEXT:    s_add_u32 s3, s4, s3
; GFX9GISEL-NEXT:    v_mov_b32_e32 v0, s2
; GFX9GISEL-NEXT:    v_mov_b32_e32 v1, s3
...
; GFX8DAGISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8DAGISEL-NEXT:    s_mul_i32 s3, s3, s6
; GFX8DAGISEL-NEXT:    s_mul_hi_u32 s7, s2, s6
; GFX8DAGISEL-NEXT:    s_mul_i32 s6, s2, s6
; GFX8DAGISEL-NEXT:    s_add_u32 s7, s7, s3
...
; GFX8DAGISEL-NEXT:    s_mul_hi_u32 s7, s4, s6
...
; GFX8GISEL-NEXT:    s_mul_hi_u32 s7, s2, s6
; GFX8GISEL-NEXT:    s_mul_i32 s6, s2, s6
; GFX8GISEL-NEXT:    s_add_u32 s7, s7, s3
...
; GFX8GISEL-NEXT:    s_mul_hi_u32 s7, s4, s6
; GFX8GISEL-NEXT:    s_mul_i32 s6, s4, s6
; GFX8GISEL-NEXT:    s_add_u32 s7, s7, s5
...
; GFX9DAGISEL-NEXT:    s_mul_i32 s3, s3, s4
; GFX9DAGISEL-NEXT:    s_mul_hi_u32 s5, s2, s4
; GFX9DAGISEL-NEXT:    s_mul_i32 s4, s2, s4
; GFX9DAGISEL-NEXT:    s_add_u32 s5, s5, s3
...
; GFX9DAGISEL-NEXT:    s_mov_b64 s[4:5], exec
; GFX9DAGISEL-NEXT:    s_bcnt1_i32_b64 s4, s[4:5]
; GFX9DAGISEL-NEXT:    s_mul_i32 s5, s7, s4
; GFX9DAGISEL-NEXT:    s_mul_hi_u32 s7, s6, s4
...
; GFX9GISEL-NEXT:    s_mul_hi_u32 s7, s2, s6
; GFX9GISEL-NEXT:    s_mul_i32 s6, s2, s6
; GFX9GISEL-NEXT:    s_add_u32 s7, s7, s3
...
; GFX9GISEL-NEXT:    s_bcnt1_i32_b64 s4, s[4:5]
; GFX9GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9GISEL-NEXT:    s_mul_i32 s5, s7, s4
; GFX9GISEL-NEXT:    s_mul_hi_u32 s7, s6, s4
